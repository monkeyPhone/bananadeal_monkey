...
//
//     final modelDetailData = modelDetailDataFromJson(jsonString);

import 'dart:convert';

ModelDetailData modelDetailDataFromJson(String str) => ModelDetailData.fromJson(json.decode(str));

String modelDetailDataToJson(ModelDetailData data) => json.encode(data.toJson());
...
class ModelDetailData {
  ...
  List<PhoneImg> phoneImg;
  List<dynamic> phoneOptionNum;

  factory ModelDetailData.fromJson(Map<String, dynamic> json) => ModelDetailData(
    result: json["result"],
    phoneSpecDetail: PhoneSpecDetail.fromJson(json["PHONE_SPEC"]),
...
class PhoneSpecDetail {
  ...
  String psCpu;
  String psDisplay;
  String psDisplaySize;
  String psCameraFront;
  String psCameraBack;
  String psWeight;
  String psHeight;
  String psWidth;
  ...
  String psInfo1;
  String psInfo2;
  String psExplainImgPath;
  String psMobileGrade;
  String psTypeAnalytics;
  ...
  String psSpecFilm;
  String psSpecUsim;
  String psSpecComponent;
  String psSpecDesign;
  String psSpecSpecial;
  String psSpecCamera;
  String psSpecAsinfo;
  String psSpecAod;
  String psSpecPay;
  ...
  factory PhoneSpecDetail.fromJson(Map<String, dynamic> json) => PhoneSpecDetail(
    psIdx: json["PS_idx"],
    mkIdx: json["mk_idx"],
    mksIdx: json["mks_idx"],
