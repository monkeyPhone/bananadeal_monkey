...
//
//     final modelName = modelNameFromJson(jsonString);

import 'dart:convert';

ModelName modelNameFromJson(String str) => ModelName.fromJson(json.decode(str));

String modelNameToJson(ModelName data) => json.encode(data.toJson());
...
class ModelName {
  ...
  List<ModelNameList> list;

  factory ModelName.fromJson(Map<String, dynamic> json) => ModelName(
    list: List<ModelNameList>.from(json["LIST"].map((x) => ModelNameList.fromJson(x))),
  );
...
class ModelNameList {
  ...
  factory ModelNameList.fromJson(Map<String, dynamic> json) => ModelNameList(
