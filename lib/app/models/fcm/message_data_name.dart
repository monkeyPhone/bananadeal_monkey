...
MessageDataName messageDataNameFromJson(String str) => MessageDataName.fromJson(json.decode(str));

String messageDataNameToJson(MessageDataName data) => json.encode(data.toJson());


class MessageDataName {
  MessageDataName({
    required this.name,
  ...
  factory MessageDataName.fromJson(Map<String, dynamic> json) => MessageDataName(
      name: json["name"] ?? '',
