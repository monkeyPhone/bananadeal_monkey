...
ModelNameEntity modelNameEntityFromJson(String str) => ModelNameEntity.fromJson(json.decode(str));

String modelNameEntityToJson(ModelNameEntity data) => json.encode(data.toJson());

class ModelNameEntity {
  ModelNameEntity({
    required this.list,
  });

  List<ModelNameDto> list;

  factory ModelNameEntity.fromJson(Map<String, dynamic> json) => ModelNameEntity(
    list: List<ModelNameDto>.from(json["LIST"].map((x) => ModelNameDto.fromJson(x))),
  );
...
class ModelNameDto {
  ...
  factory ModelNameDto.fromJson(Map<String, dynamic> json) => ModelNameDto(
