List<EstimateVO> convertEstimateVO(List<dynamic> data) {
  return data.map((item) => EstimateVO.fromJson(item as Map<String, dynamic>)).toList();
}
...
class EstimateVO {
  ...
  factory EstimateVO.fromJson(Map<String, dynamic> json) {
